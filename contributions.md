...
|**@T0hsakaR1n126**| 06-04-2025 |https://github.com/T0hsakaR1n126/sopra-fs25-group-10-server/commit/0330aaefd5442f79c05558870fef40a739b87bdd | implement relevant controller, service and DTO of gamelobby | Every combat game should be displayed in lobby and users can type password or not to enter game. |implement relevant service and DTO of gamejoin | Every player who join the game should use this function(typing password or not to join). |
